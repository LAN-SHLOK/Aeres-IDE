  ...
  return (
    <div className="flex items-center gap-4 px-3 py-1 bg-white/[0.02] border border-white/[0.05] rounded-lg">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[10px] uppercase tracking-wider text-aether-muted font-bold">Neural Core: Active</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-aether-violet font-mono leading-none">42ms</span>
        </div>
      </div>
    </div>
  )
