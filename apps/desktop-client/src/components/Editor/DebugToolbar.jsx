...
export default function DebugToolbar() {
  ...
  return (
    <div className="fixed top-12 left-1/2 -translate-x-1/2 z-[4000] flex items-center gap-1 bg-aeres-surface border border-aeres-border rounded-lg shadow-2xl p-1 animate-in fade-in slide-in-from-top-4">
      <div className="flex items-center gap-0.5 px-2 border-r border-aeres-border mr-1">
        <span className="w-2 h-2 rounded-full bg-aeres-violet animate-pulse mr-2" />
      ...
      <div className="w-px h-4 bg-aeres-border mx-1" />
